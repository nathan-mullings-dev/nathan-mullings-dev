...
I’m an aspiring Data Technician/Analyst whom as recently finished a **Data Skills Bootcamp** with **Just IT** where I’ve been developing and growing my skill set in [SQL](https://github.com/nathan-mullings-dev/sql-project-justit), [Python](https://github.com/nathan-mullings-dev/python-project-justit), [Excel](https://github.com/nathan-mullings-dev/excel-project-justit), [Tableau](https://github.com/nathan-mullings-dev/tableau-global-superstore-dashboard-project-justit), [Power BI](https://github.com/nathan-mullings-dev/power-bi-project-justit), and [Azure](https://github.com/nathan-mullings-dev/microsoft-azure-project-justit), and building hands-on projects along the way. I’m all about turning raw data into useful insights and love finding practical ways to make things work better. Always learning, always curious—and excited to grow in the data space! Please check out my [repositories](https://github.com/nathan-mullings-dev?tab=repositories) to see my work!
